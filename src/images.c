...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/10 18:10:54 by lpesan            #+#    #+#             */
/*   Updated: 2024/07/10 20:39:00 by lpesan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_textures(t_game *game)
{
	...
	game->textu->collec = mlx_load_png("./textures/rum.png");
	game->textu->chara = mlx_load_png("./textures/man.png");
	game->textu->exit = mlx_load_png("./textures/exit.png");
	game->textu->exit_2 = mlx_load_png("./textures/sun.png");
}
